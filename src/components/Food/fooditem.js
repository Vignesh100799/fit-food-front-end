export const nonVegTips = {
    ...
    "loseWeight": {
        ...
        "thursday": {
            ...
            "dinner": ["Grilled shrimp with quinoa", "Sautéed spinach", "Mixed berries"]
        },
        "friday": {
...
export const vegTips = {
    "gainWeight": {
        "sunday": {
            "breakfast": ["Oatmeal with whole milk and sliced banana", "Boiled eggs", "Green tea"],
            "lunch": ["Quinoa salad with mixed vegetables", "Sweet potato", "Greek yogurt with berries"],
            "snack": ["Greek yogurt with honey", "Walnuts"],
            "dinner": ["Beef stir-fry with quinoa", "Baked sweet potato", "Asparagus", "Orange slices"]
        },
        "monday": {
